...
| File | Content |
|------|---------|
| `StratCraft Benchmark 2026-08-13.md` | Cross-system feature benchmark (StratCraft vs. OrcaAlgo) — structured catalog, comparison matrix, and the 12 implemented recommendations |
